...
public:
	...
	DllExport const wchar_t* getName(unsigned int uiForm = 0) const;																											// Exposed to Python
	DllExport const wchar_t* getNameKey() const;																																	// Exposed to Python
	DllExport const wchar_t* getCivilizationDescription(unsigned int uiForm = 0) const;																		// Exposed to Python
	DllExport const wchar_t* getCivilizationDescriptionKey() const;																								// Exposed to Python
	DllExport const wchar_t* getCivilizationShortDescription(unsigned int uiForm = 0) const;															// Exposed to Python 
	DllExport const wchar_t* getCivilizationShortDescriptionKey() const;																					// Exposed to Python 
	DllExport const wchar_t* getCivilizationAdjective(unsigned int uiForm = 0) const;																			// Exposed to Python
	DllExport const wchar_t* getCivilizationAdjectiveKey() const;																									// Exposed to Python
	DllExport CvWString getFlagDecal() const;																																		// Exposed to Python
	DllExport bool isWhiteFlag() const;																																					// Exposed to Python
	DllExport const wchar_t* getStateReligionName(unsigned int uiForm = 0) const;																					// Exposed to Python
	DllExport const wchar_t* getStateReligionKey() const;																													// Exposed to Python
	DllExport const CvWString getBestAttackUnitName(unsigned int uiForm = 0) const;																								// Exposed to Python
...
#if ENABLE_GAMECOREDLL_ENHANCEMENTS
	void initPlayerTradeNetworkSystem();
	GiganticMapsOptimisationsLib::PlayerTradeNetworkSystem* getPlayerTradeNetworkSystem();
#endif
...
//#else
	//bool isBestFoundValuePositive() const;
//#endif
	...
	int countUnimprovedBonuses(CvArea* pArea, CvPlot* pFromPlot = nullptr) const;														// Exposed to Python
	...
	int countPotentialForeignTradeCities(CvArea* pIgnoreArea = nullptr) const;																// Exposed to Python
	...
	// fortsnek: const
	RouteTypes getBestRoute(const CvPlot* pPlot = nullptr) const;																						// Exposed to Python
	...
	int getEspionageMissionCost(EspionageMissionTypes eMission, PlayerTypes eTargetPlayer, const CvPlot* pPlot = nullptr, int iExtraData = -1, const CvUnit* pSpyUnit = nullptr) const;		// Exposed to Python
	int getEspionageMissionCostModifier(EspionageMissionTypes eMission, PlayerTypes eTargetPlayer, const CvPlot* pPlot = nullptr, int iExtraData = -1, const CvUnit* pSpyUnit = nullptr) const;
	...
	DllExport int getAdvancedStartUnitCost(UnitTypes eUnit, bool bAdd, CvPlot* pPlot = nullptr) const;																													// Exposed to Python 
	DllExport int getAdvancedStartCityCost(bool bAdd, CvPlot* pPlot = nullptr) const;																													// Exposed to Python 
	DllExport int getAdvancedStartPopCost(bool bAdd, CvCity* pCity = nullptr) const;																													// Exposed to Python 
	DllExport int getAdvancedStartCultureCost(bool bAdd, CvCity* pCity = nullptr) const;																													// Exposed to Python 
	DllExport int getAdvancedStartBuildingCost(BuildingTypes eBuilding, bool bAdd, CvCity* pCity = nullptr) const;																													// Exposed to Python 
	DllExport int getAdvancedStartImprovementCost(ImprovementTypes eImprovement, bool bAdd, CvPlot* pPlot = nullptr) const;																													// Exposed to Python 
	DllExport int getAdvancedStartRouteCost(RouteTypes eRoute, bool bAdd, CvPlot* pPlot = nullptr) const;																													// Exposed to Python 
	DllExport int getAdvancedStartTechCost(TechTypes eTech, bool bAdd) const;																													// Exposed to Python 
	DllExport int getAdvancedStartVisibilityCost(bool bAdd, CvPlot* pPlot = nullptr) const;																													// Exposed to Python 
	...
	DllExport void setStartTime(unsigned int uiStartTime);
	DllExport unsigned int getTotalTimePlayed() const;																																// Exposed to Python			  
	...
	DllExportForInterface bool isAutoMoves() const;
	...
	DllExportForInterface bool isCommerceFlexible(CommerceTypes eIndex) const;																							// Exposed to Python
	...
	int getCivicUpkeep(CivicTypes* paeCivics = nullptr, bool bIgnoreAnarchy = false) const;							// Exposed to Python					
...
#ifdef ENABLE_GAMECOREDLL_ENHANCEMENTS
	bool isUnitInGroupCycle(const CvUnit* unit) const;
#endif
	...
	virtual int AI_foundValue(int iX, int iY, int iMinUnitRange = -1, bool bStartingLoc = false
#if ENABLE_GAMECOREDLL_ENHANCEMENTS
		, int startingPlotRangeOverride = -1
#endif
	) const = 0; // Exposed to Python
	...
	virtual int AI_plotTargetMissionAIs(const CvPlot* pPlot, MissionAITypes eMissionAI, const CvSelectionGroup* pSkipSelectionGroup = nullptr, int iRange = 0) const = 0;
	virtual int AI_unitTargetMissionAIs(const CvUnit* pUnit, MissionAITypes eMissionAI, const CvSelectionGroup* pSkipSelectionGroup = nullptr) const = 0;
...
#ifdef ENABLE_GAMECOREDLL_ENHANCEMENTS
	std::unordered_set<int> m_groupCycleSet;
#endif
...
#ifdef ENABLE_GAMECOREDLL_ENHANCEMENTS
	GiganticMapsOptimisationsLib::PlayerTradeNetworkSystem* m_playerTradeNetworkSystem = nullptr;
#endif
