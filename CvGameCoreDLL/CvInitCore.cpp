...
bool CvInitCore::getGameMultiplayer() const
{
...
{
	FASSERT_BOUNDS(0, MAX_CIV_PLAYERS, std::to_underlying(eID), "CvInitCore::getSlotVacant");
...
{
	FASSERT_BOUNDS(0, MAX_CIV_PLAYERS, std::to_underlying(eOldID), "CvInitCore::reassignPlayer (eOldID)");
	FASSERT_BOUNDS(0, MAX_CIV_PLAYERS, std::to_underlying(eNewID), "CvInitCore::reassignPlayer (eNewID)");
...
void CvInitCore::resetGame(CvInitCore * pSource, bool bClear, bool bSaveGameType)
{
	...
	if (pSource)
	{
		...
		setWorldSizeMultiplier(pSource->getWorldSizeMultiplier());
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::resetPlayer");
...
const CvWString& CvInitCore::getGameName() const { return m_szGameName; }
void CvInitCore::setGameName(const CvWString& szGameName) { m_szGameName = szGameName; }

const CvWString& CvInitCore::getGamePassword() const { return m_szGamePassword; }
void CvInitCore::setGamePassword(const CvWString& szGamePassword) { m_szGamePassword = szGamePassword; }

const CvWString& CvInitCore::getAdminPassword() const { return m_szAdminPassword; }
...
{
	return m_bWBMapNoPlayers;
}
void CvInitCore::setWBMapNoPlayers(bool bValue)
{
	m_bWBMapNoPlayers = bValue; 
}

WorldSizeTypes CvInitCore::getWorldSize() const
{
	return m_eWorldSize;
}
void CvInitCore::setWorldSize(WorldSizeTypes eWorldSize)
{
	m_eWorldSize = eWorldSize;
}
...
int CvInitCore::getWorldSizeMultiplier() const
{
	return m_iWorldSizeMultiplier;
}

void CvInitCore::setWorldSizeMultiplier(int x)
{
	m_iWorldSizeMultiplier = std::max(x, 1);
}

ClimateTypes CvInitCore::getClimate() const { return m_eClimate; }
void CvInitCore::setClimate(ClimateTypes eClimate) { m_eClimate = eClimate; }
...
SeaLevelTypes CvInitCore::getSeaLevel() const { return m_eSeaLevel; }
void CvInitCore::setSeaLevel(SeaLevelTypes eSeaLevel) { m_eSeaLevel = eSeaLevel; }
...
EraTypes CvInitCore::getEra() const { return m_eEra; }
void CvInitCore::setEra(EraTypes eEra) {  m_eEra = eEra; }
...
GameSpeedTypes CvInitCore::getGameSpeed() const {  return m_eGameSpeed; }
void CvInitCore::setGameSpeed(GameSpeedTypes eGameSpeed) { m_eGameSpeed = eGameSpeed; }
...
TurnTimerTypes CvInitCore::getTurnTimer() const { return m_eTurnTimer; }
void CvInitCore::setTurnTimer(TurnTimerTypes eTurnTimer) { m_eTurnTimer = eTurnTimer; }
...
CalendarTypes CvInitCore::getCalendar() const { return m_eCalendar; }
void CvInitCore::setCalendar(CalendarTypes eCalendar) { m_eCalendar = eCalendar; }
...
int CvInitCore::getNumCustomMapOptions() const { return m_iNumCustomMapOptions; }
int CvInitCore::getNumHiddenCustomMapOptions() const { return m_iNumHiddenCustomMapOptions; }

const CustomMapOptionTypes* CvInitCore::getCustomMapOptions() const { return m_aeCustomMapOptions; }
...
int CvInitCore::getNumVictories() const { return m_iNumVictories; }

const bool* CvInitCore::getVictories() const { return m_abVictories; }
...
const bool* CvInitCore::getOptions() const { return m_abOptions; }
const bool* CvInitCore::getMPOptions() const { return m_abMPOptions; }
bool CvInitCore::getStatReporting() const { return m_bStatReporting; }
void CvInitCore::setStatReporting(bool bStatReporting) { m_bStatReporting = bStatReporting; }
const bool* CvInitCore::getForceControls() const { return m_abForceControls; }
int CvInitCore::getGameTurn() const { return m_iGameTurn; }
void CvInitCore::setGameTurn(int iGameTurn) { m_iGameTurn = iGameTurn; }

int CvInitCore::getMaxTurns() const { return m_iMaxTurns; }
void CvInitCore::setMaxTurns(int iMaxTurns) { m_iMaxTurns = iMaxTurns; }

int CvInitCore::getPitbossTurnTime() const { return m_iPitbossTurnTime; }
void CvInitCore::setPitbossTurnTime(int iPitbossTurnTime) { m_iPitbossTurnTime = iPitbossTurnTime; }

int CvInitCore::getTargetScore() const { return m_iTargetScore; }
void CvInitCore::setTargetScore(int iTargetScore) { m_iTargetScore = iTargetScore; }


int CvInitCore::getMaxCityElimination() const { return m_iMaxCityElimination; }
void CvInitCore::setMaxCityElimination(int iMaxCityElimination) { m_iMaxCityElimination = iMaxCityElimination; }

int CvInitCore::getNumAdvancedStartPoints() const { return m_iNumAdvancedStartPoints; }
void CvInitCore::setNumAdvancedStartPoints(int iNumPoints) { m_iNumAdvancedStartPoints = iNumPoints; }

unsigned int CvInitCore::getSyncRandSeed() const { return m_uiSyncRandSeed; }
void CvInitCore::setSyncRandSeed(unsigned int uiSyncRandSeed) { m_uiSyncRandSeed = uiSyncRandSeed; }

unsigned int CvInitCore::getMapRandSeed() const { return m_uiMapRandSeed; }
void CvInitCore::setMapRandSeed(unsigned int uiMapRandSeed) { m_uiMapRandSeed = uiMapRandSeed; }

PlayerTypes CvInitCore::getActivePlayer() const { return m_eActivePlayer; }
...
GameType CvInitCore::getType() const { return m_eType; }
...
GameMode CvInitCore::getMode() const { return m_eMode; }
...
const CvWString & CvInitCore::getLeaderName(PlayerTypes eID, unsigned int uiForm) const
{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setLeaderName");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getLeaderNameKey");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
const CvWString & CvInitCore::getCivDescription(PlayerTypes eID, unsigned int uiForm) const
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getCivDescription");
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setCivDescription");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getCivDescriptionKey");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
const CvWString & CvInitCore::getCivShortDesc(PlayerTypes eID, unsigned int uiForm) const
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getCivShortDesc");
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setCivShortDesc");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getCivShortDescKey");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
const CvWString & CvInitCore::getCivAdjective(PlayerTypes eID, unsigned int uiForm) const
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getCivAdjective");
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setCivAdjective");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getCivAdjectiveKey");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getCivPassword");
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setCivPassword");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getEmail");
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setEmail");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getSmtpHost");
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setSmtpHost");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getWhiteFlag");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setWhiteFlag");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getFlagDecal");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setFlagDecal");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getCiv");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
		return m_aeCiv[eID];
	}
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setCiv");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
		m_aeCiv[eID] = eCiv;
	}
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getLeader");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setLeader");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getTeam");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
		return m_aeTeam[eID];
	}
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setTeam");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getHandicap");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setHandicap");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getColor");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setColor");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getArtStyle");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setArtStyle");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getSlotStatus");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setSlotStatus");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getSlotClaim");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setSlotClaim");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getReady");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setReady");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getPlayableCiv");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
		...
		else
		{
			...
			else
			{
				...
				return std::to_underlying(eID) < MAX_CIV_PLAYERS;
			}
		}
	}
	else
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setPlayableCiv");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getMinorNationCiv");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setMinorNationCiv");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getNetID");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setNetID");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getPythonCheck");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setPythonCheck");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::getXMLCheck");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
...
{
	FASSERT_BOUNDS(0, MAX_PLAYERS, std::to_underlying(eID), "CvInitCore::setXMLCheck");
	if ( checkBounds(eID, 0, MAX_PLAYERS) )
	{
