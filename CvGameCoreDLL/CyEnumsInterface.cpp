...
void CyEnumsPythonInterface(pybind11::module m)
{
	...
	cyenum<CameraLookAtTypes>(m, "CameraLookAtTypes")
	...
	cyenum<CameraMovementSpeeds>(m, "CameraMovementSpeeds")
	...
	cyenum<ZoomLevelTypes>(m, "ZoomLevelTypes")
	...
	cyenum<DirectionTypes>(m, "DirectionTypes")
	...
	cyenum<CardinalDirectionTypes>(m, "CardinalDirectionTypes")
	...
	cyenum<ColorTypes>(m, "ColorTypes")
		.value("NO_COLOR", NO_COLOR)
		;

	cyenum<PlayerColorTypes>(m, "PlayerColorTypes")
		.value("NO_PLAYERCOLOR", NO_PLAYERCOLOR)
		;

	cyenum<PlotStyles>(m, "PlotStyles")
	...
	cyenum<PlotLandscapeLayers>(m, "PlotLandscapeLayers")
	...
	cyenum<AreaBorderLayers>(m, "AreaBorderLayers")
	...
	cyenum<InterfaceModeTypes>(m, "InterfaceModeTypes")
	...
	cyenum<InterfaceMessageTypes>(m, "InterfaceMessageTypes")
	...
	cyenum<MinimapModeTypes>(m, "MinimapModeTypes")
	...
	cyenum<EngineDirtyBits>(m, "EngineDirtyBits")
	...
	cyenum<InterfaceDirtyBits>(m, "InterfaceDirtyBits")
	...
	cyenum<CityTabTypes>(m, "CityTabTypes")
	...
	cyenum<WidgetTypes>(m, "WidgetTypes")
	...
	cyenum<ButtonPopupTypes>(m, "ButtonPopupTypes")
	...
	cyenum<ClimateTypes>(m, "ClimateTypes")
		.value("NO_CLIMATE", NO_CLIMATE)
		;

	cyenum<SeaLevelTypes>(m, "SeaLevelTypes")
		.value("NO_SEALEVEL", NO_SEALEVEL)
		;

	cyenum<CustomMapOptionTypes>(m, "CustomMapOptionTypes")
		.value("NO_CUSTOM_MAPOPTION", NO_CUSTOM_MAPOPTION)
		;

	cyenum<WorldSizeTypes>(m, "WorldSizeTypes")
	...
	cyenum<TerrainTypes>(m, "TerrainTypes")
		.value("NO_TERRAIN", NO_TERRAIN)
		;

	cyenum<PlotTypes>(m, "PlotTypes")
	...
	cyenum<YieldTypes>(m, "YieldTypes")
	...
	cyenum<CommerceTypes>(m, "CommerceTypes")
	...
	cyenum<AdvisorTypes>(m, "AdvisorTypes")
		.value("NO_ADVISOR", NO_ADVISOR)
		;

	cyenum<FlavorTypes>(m, "FlavorTypes")
		.value("NO_FLAVOR", NO_FLAVOR)
		;

	cyenum<EmphasizeTypes>(m, "EmphasizeTypes")
		.value("NO_EMPHASIZE", NO_EMPHASIZE)
		;

	cyenum<GameOptionTypes>(m, "GameOptionTypes")
	...
	cyenum<MultiplayerOptionTypes>(m, "MultiplayerOptionTypes")
	...
	cyenum<SpecialOptionTypes>(m, "SpecialOptionTypes")
	...
	cyenum<PlayerOptionTypes>(m, "PlayerOptionTypes")
	...
	cyenum<GraphicOptionTypes>(m, "GraphicOptionTypes")
	...
	cyenum<ForceControlTypes>(m, "ForceControlTypes")
	...
	cyenum<VictoryTypes>(m, "VictoryTypes")
		.value("NO_VICTORY", NO_VICTORY)
		;

	cyenum<FeatureTypes>(m, "FeatureTypes")
		.value("NO_FEATURE", NO_FEATURE)
		;

	cyenum<BonusTypes>(m, "BonusTypes")
		.value("NO_BONUS", NO_BONUS)
		;

	cyenum<BonusClassTypes>(m, "BonusClassTypes")
		.value("NO_BONUSCLASS", NO_BONUSCLASS)
		;

	cyenum<ImprovementTypes>(m, "ImprovementTypes")
		.value("NO_IMPROVEMENT", NO_IMPROVEMENT)
		;

	cyenum<RouteTypes>(m, "RouteTypes")
		.value("NO_ROUTE", NO_ROUTE)
		;

	cyenum<RiverTypes>(m, "RiverTypes")
		.value("NO_RIVER", NO_RIVER)
		;

	cyenum<GoodyTypes>(m, "GoodyTypes")
		.value("NO_GOODY", NO_GOODY)
		;

	cyenum<BuildTypes>(m, "BuildTypes")
		.value("NO_BUILD", NO_BUILD)
		;

	cyenum<SymbolTypes>(m, "SymbolTypes")
		.value("NO_SYMBOL", NO_SYMBOL)
		;

	cyenum<FontSymbols>(m, "FontSymbols")
	...
	cyenum<HandicapTypes>(m, "HandicapTypes")
		.value("NO_HANDICAP", NO_HANDICAP)
		;

	cyenum<GameSpeedTypes>(m, "GameSpeedTypes")
		.value("NO_GAMESPEED", NO_GAMESPEED)
		;

	cyenum<TurnTimerTypes>(m, "TurnTimerTypes")
		.value("NO_TURNTIMER", NO_TURNTIMER)
		;

	cyenum<EraTypes>(m, "EraTypes")
		.value("NO_ERA", NO_ERA)
		;

	cyenum<CivilizationTypes>(m, "CivilizationTypes")
		.value("NO_CIVILIZATION", NO_CIVILIZATION)
		;

	cyenum<LeaderHeadTypes>(m, "LeaderHeadTypes")
		.value("NO_LEADER", NO_LEADER)
		;

	cyenum<ArtStyleTypes>(m, "ArtStyleTypes")
		.value("NO_ARTSTYLE", NO_ARTSTYLE)
		;

	cyenum<CitySizeTypes>(m, "CitySizeTypes")
	...
	cyenum<TeamTypes>(m, "TeamTypes")
		.value("NO_TEAM", NO_TEAM)
		;

	cyenum<PlayerTypes>(m, "PlayerTypes")
		.value("NO_PLAYER", NO_PLAYER)
		;

	cyenum<TraitTypes>(m, "TraitTypes")
		.value("NO_TRAIT", NO_TRAIT)
		;

	cyenum<OrderTypes>(m, "OrderTypes")
	...
	cyenum<BuildingClassTypes>(m, "BuildingClassTypes")
		.value("NO_BUILDINGCLASS", NO_BUILDINGCLASS)
		;

	cyenum<BuildingTypes>(m, "BuildingTypes")
		.value("NO_BUILDING", NO_BUILDING)
		;

	cyenum<SpecialBuildingTypes>(m, "SpecialBuildingTypes")
		.value("NO_SPECIALBUILDING", NO_SPECIALBUILDING)
		;

	cyenum<ProjectTypes>(m, "ProjectTypes")
		.value("NO_PROJECT", NO_PROJECT)
		;

	cyenum<ProcessTypes>(m, "ProcessTypes")
		.value("NO_PROCESS", NO_PROCESS)
		;

	cyenum<VoteTypes>(m, "VoteTypes")
		.value("NO_VOTE", NO_VOTE)
		;

	cyenum<PlayerVoteTypes>(m, "PlayerVoteTypes")
	...
	cyenum<InfoBarTypes>(m, "InfoBarTypes")
	...
	cyenum<HealthBarTypes>(m, "HealthBarTypes")
	...
	cyenum<ConceptTypes>(m, "ConceptTypes")
		.value("NO_CONCEPT", NO_CONCEPT)
		;

	cyenum<NewConceptTypes>(m, "NewConceptTypes")
		.value("NO_NEW_CONCEPT", NO_NEW_CONCEPT)
		;

	cyenum<CalendarTypes>(m, "CalendarTypes")
	...
	cyenum<SeasonTypes>(m, "SeasonTypes")
		.value("NO_SEASON", NO_SEASON)
		;

	cyenum<MonthTypes>(m, "MonthTypes")
		.value("NO_MONTH", NO_MONTH)
		;

	cyenum<DenialTypes>(m, "DenialTypes")
	...
	cyenum<DomainTypes>(m, "DomainTypes")
	...
	cyenum<UnitClassTypes>(m, "UnitClassTypes")
		.value("NO_UNITCLASS", NO_UNITCLASS)
		;

	cyenum<UnitTypes>(m, "UnitTypes")
		.value("NO_UNIT", NO_UNIT)
		;

	cyenum<SpecialUnitTypes>(m, "SpecialUnitTypes")
		.value("NO_SPECIALUNIT", NO_SPECIALUNIT)
		;

	cyenum<UnitCombatTypes>(m, "UnitCombatTypes")
		.value("NO_UNITCOMBAT", NO_UNITCOMBAT)
		;

	cyenum<UnitAITypes>(m, "UnitAITypes")
	...
	cyenum<InvisibleTypes>(m, "InvisibleTypes")
		.value("NO_INVISIBLE", NO_INVISIBLE)
		;

	cyenum<VoteSourceTypes>(m, "VoteSourceTypes")
		.value("NO_VOTESOURCE", NO_VOTESOURCE)
		;

	cyenum<ProbabilityTypes>(m, "ProbabilityTypes")
	...
	cyenum<ActivityTypes>(m, "ActivityTypes")
	...
	cyenum<AutomateTypes>(m, "AutomateTypes")
	...
	cyenum<MissionTypes>(m, "MissionTypes")
	...
	cyenum<MissionAITypes>(m, "MissionAITypes")
	...
	cyenum<CommandTypes>(m, "CommandTypes")
	...
	cyenum<ControlTypes>(m, "ControlTypes")
	...
	cyenum<PromotionTypes>(m, "PromotionTypes")
		.value("NO_PROMOTION", NO_PROMOTION)
		;

	cyenum<TechTypes>(m, "TechTypes")
		.value("NO_TECH", NO_TECH)
		;

	cyenum<SpecialistTypes>(m, "SpecialistTypes")
		.value("NO_SPECIALIST", NO_SPECIALIST)
		;

	cyenum<ReligionTypes>(m, "ReligionTypes")
		.value("NO_RELIGION", NO_RELIGION)
		;

	cyenum<CorporationTypes>(m, "CorporationTypes")
		.value("NO_CORPORATION", NO_CORPORATION)
		;

	cyenum<HurryTypes>(m, "HurryTypes")
		.value("NO_HURRY", NO_HURRY)
		;

	cyenum<UpkeepTypes>(m, "UpkeepTypes")
		.value("NO_UPKEEP", NO_UPKEEP)
		;

	cyenum<CultureLevelTypes>(m, "CultureLevelTypes")
		.value("NO_CULTURELEVEL", NO_CULTURELEVEL)
		;

	cyenum<CivicOptionTypes>(m, "CivicOptionTypes")
		.value("NO_CIVICOPTION", NO_CIVICOPTION)
		;

	cyenum<CivicTypes>(m, "CivicTypes")
		.value("NO_CIVIC", NO_CIVIC)
		;

	cyenum<WarPlanTypes>(m, "WarPlanTypes")
	...
	cyenum<AreaAITypes>(m, "AreaAITypes")
	...
	cyenum<EndTurnButtonStates>(m, "EndTurnButtonStates")
	...
	cyenum<FogOfWarModeTypes>(m, "FogOfWarModeTypes")
	...
	cyenum<AnimationTypes>(m, "AnimationTypes")
	...
	cyenum<EntityEventTypes>(m, "EntityEventTypes")
		.value( "ENTITY_EVENT_NONE", ENTITY_EVENT_NONE )
		;

	cyenum<AnimationPathTypes>(m, "AnimationPathTypes")
	...
	cyenum<AnimationCategoryTypes>(m, "AnimationCategoryTypes")
		.value("ANIMCAT_NONE", ANIMCAT_NONE)
		;

	cyenum<CursorTypes>(m, "CursorTypes")
		.value("NO_CURSOR", NO_CURSOR)
		;

	cyenum<TradeableItems>(m, "TradeableItems")
	...
	cyenum<DiploEventTypes>(m, "DiploEventTypes")
	...
	cyenum<DiploCommentTypes>(m, "DiploCommentTypes")
		.value("NO_DIPLOCOMMENT", NO_DIPLOCOMMENT)
		;

	cyenum<NetContactTypes>(m, "NetContactTypes")
	...
	cyenum<ContactTypes>(m, "ContactTypes")
	...
	cyenum<MemoryTypes>(m, "MemoryTypes")
	...
	cyenum<AttitudeTypes>(m, "AttitudeTypes")
	...
	cyenum<LeaderheadAction>(m, "LeaderheadAction")
	...
	cyenum<DiplomacyPowerTypes>(m, "DiplomacyPowerTypes")
	...
	cyenum<SaveGameTypes>(m, "SaveGameTypes")
	...
	cyenum<InterfaceVisibility>(m, "InterfaceVisibility")
	...
	cyenum<GenericButtonSizes>(m, "GenericButtonSizes")
	...
	cyenum<WorldBuilderPopupTypes>(m, "WorldBuilderPopupTypes")
	...
	cyenum<PanelStyles>(m, "PanelStyles")
	...
	cyenum<ButtonStyles>(m, "ButtonStyles")
	...
	cyenum<TableStyles>(m, "TableStyles")
	...
	cyenum<ReplayMessageTypes>(m, "ReplayMessageTypes")
	...
	cyenum<CivilopediaPageTypes>(m, "CivilopediaPageTypes")
	...
	cyenum<ActionSubTypes>(m, "ActionSubTypes")
	...
	cyenum<GameMessageTypes>(m, "GameMessageTypes")
	...
	cyenum<PopupControlLayout>(m, "PopupControlLayout")
	...
	cyenum<JustificationTypes>(m, "JustificationTypes")
	...
	cyenum<ToolTipAlignTypes>(m, "ToolTipAlignTypes")
	...
	cyenum<ActivationTypes>(m, "ActivationTypes")
	...
	cyenum<HitTestTypes>(m, "HitTestTypes")
	...
	cyenum<GraphicLevelTypes>(m, "GraphicLevelTypes")
	...
	cyenum<EventTypes>(m, "EventTypes")
		.value("NO_EVENT", NO_EVENT)
		;

	cyenum<EventTriggerTypes>(m, "EventTriggerTypes")
		.value("NO_EVENTTRIGGER", NO_EVENTTRIGGER)
		;

	cyenum<EspionageMissionTypes>(m, "EspionageMissionTypes")
		.value("NO_ESPIONAGEMISSION", NO_ESPIONAGEMISSION)
		;

	cyenum<AdvancedStartActionTypes>(m, "AdvancedStartActionTypes")
