...
public:
	...
	DllExport void pushMission(MissionTypes eMission, int iData1 = -1, int iData2 = -1, int iFlags = 0, bool bAppend = false, bool bManual = false, MissionAITypes eMissionAI = NO_MISSIONAI, CvPlot* pMissionAIPlot = nullptr, CvUnit* pMissionAIUnit = nullptr);		// Exposed to Python
	void popMission();																																										// Exposed to Python
	DllExport void autoMission();
	void updateMission();
	DllExport CvPlot* lastMissionPlot();																																					// Exposed to Python

	DllExport bool canStartMission(int iMission, int iData1, int iData2, CvPlot* pPlot = nullptr, bool bTestVisible = false, bool bUseCache = false);		// Exposed to Python
	void startMission();
	...
	int getCargo() const;
	// fortsnek: const
	DllExport bool canAllMove() const;																																				// Exposed to Python
	// fortsnek: const
	...
	// fortsnek: const
	DllExport bool canMoveOrAttackInto(CvPlot* pPlot, bool bDeclareWar = false) const;												// Exposed to Python
	// fortsnek: const
	bool canMoveThrough(CvPlot* pPlot) const;																																	// Exposed to Python
	// fortsnek: const
	...
	// fortsnek: const
	RouteTypes getBestBuildRoute(const CvPlot* pPlot, BuildTypes* peBestBuild = nullptr) const;	// Exposed to Python
	...
	DllExportForInterface ActivityTypes getActivityType() const;																															// Exposed to Python
	...
	CvSelectionGroup* splitGroup(int iSplitSize, CvUnit* pNewHeadUnit = nullptr, CvSelectionGroup** ppOtherGroup = nullptr);
	...
	DllExportForInterface int getMissionType(int iNode) const;																														// Exposed to Python
	...
	// fortsnek: const
	virtual bool AI_isDeclareWar(const CvPlot* pPlot = nullptr) const = 0;
	// fortsnek: const
