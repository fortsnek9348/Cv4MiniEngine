...
#if defined(FASSERT_ENABLE) && defined(_WIN32)
...
#define IDC_COPY_TO_CLIPBOARD           1006
	...
	INT_PTR CALLBACK AssertDlgProc(HWND hDlg, UINT msg,WPARAM wParam, [[maybe_unused]] LPARAM lParam)
	{
		switch(msg)
		{
		case WM_INITDIALOG:
	...
	DWORD DisplayAssertDialog()
	{
		...
		int res = static_cast<int>(DialogBoxIndirect(GetModuleHandle(0), dialogTemplate.GetDialogTemplate(), nullptr, (DLGPROC)AssertDlgProc));
		return res;
	}
