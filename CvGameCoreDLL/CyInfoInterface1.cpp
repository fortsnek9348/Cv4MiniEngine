...
void CyInfoPythonInterface1(pybind11::module m)
{
	...
	pybind11::class_<CvInfoBase>(m, "CvInfoBase")
	...
	pybind11::class_<CvScalableInfo>(m, "CvScalableInfo")
		.def("setScale", &CvScalableInfo::setScale, "void (float fScale)")
		.def("getScale", &CvScalableInfo::getScale, "float  ()")
		;

	pybind11::class_<CvSpecialistInfo, CvInfoBase>(m, "CvSpecialistInfo")
	...
	pybind11::class_<CvTechInfo, CvInfoBase >(m, "CvTechInfo")
	...
	pybind11::class_<CvPromotionInfo, CvInfoBase >(m, "CvPromotionInfo")
	...
	pybind11::class_<CvMissionInfo, CvInfoBase >(m, "CvMissionInfo")
	...
	pybind11::class_<CvActionInfo>(m, "CvActionInfo")
	...
	pybind11::class_<CvUnitInfo, CvInfoBase/*, CvScalableInfo*/>(m, "CvUnitInfo")
		...
		.def("getArtInfo", &CvUnitInfo::getArtInfo,  pybind11::return_value_policy::reference, "CvArtInfoUnit* (int i, bool bLate)")
		;

	pybind11::class_<CvSpecialUnitInfo, CvInfoBase >(m, "CvSpecialUnitInfo")
	...
	pybind11::class_<CvCivicOptionInfo, CvInfoBase >(m, "CvCivicOptionInfo")
		.def("getTraitNoUpkeep", &CvCivicOptionInfo::getTraitNoUpkeep, "bool (int i)")
		;

	pybind11::class_<CvCivicInfo, CvInfoBase >(m, "CvCivicInfo")
	...
	pybind11::class_<CvUnitClassInfo, CvInfoBase >(m, "CvUnitClassInfo")
	...
	pybind11::class_<CvBuildingInfo, CvInfoBase>(m, "CvBuildingInfo")
		...
		.def("getArtInfo", &CvBuildingInfo::getArtInfo,  pybind11::return_value_policy::reference)
		;

	pybind11::class_<CvSpecialBuildingInfo, CvInfoBase >(m, "CvSpecialBuildingInfo")
