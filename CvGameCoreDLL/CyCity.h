...
public:
	...
	void setWallOverridePoints(const pybind11::tuple& kPoints); /* points are given in world space ... i.e. PlotXToPointX, etc */
	pybind11::tuple getWallOverridePoints() const;
