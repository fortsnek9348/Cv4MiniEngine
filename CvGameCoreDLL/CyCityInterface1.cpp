...
void CyCityPythonInterface1(pybind11::class_<CyCity>& x)
{
	...
	x
		...
		.def("getCityIndexPlot", &CyCity::getCityIndexPlot, pybind11::return_value_policy::take_ownership, "CyPlot* (int iIndex)")		
		...
		.def("plot", &CyCity::plot, pybind11::return_value_policy::take_ownership, "CyPlot () - returns cities plot instance")
		...
		.def("area", &CyCity::area, pybind11::return_value_policy::take_ownership, "CyArea() () - returns CyArea instance for location of city")
		.def("waterArea", &CyCity::waterArea, pybind11::return_value_policy::take_ownership, "CyArea* ()")
		.def("getRallyPlot", &CyCity::getRallyPlot, pybind11::return_value_policy::take_ownership, "CyPlot () - returns city's rally plot instance")
		...
		.def("getTradeCity", &CyCity::getTradeCity, pybind11::return_value_policy::take_ownership, "CyCity (int iIndex) - remove SpecialistType[iIndex]")
		...
		.def("getOrderFromQueue", &CyCity::getOrderFromQueue, pybind11::return_value_policy::take_ownership, "OrderData* (int iIndex)")

		.def("setWallOverridePoints", &CyCity::setWallOverridePoints, "setWallOverridePoints(const pybind11::tuple& kPoints)")
		.def("getWallOverridePoints", &CyCity::getWallOverridePoints, "pybind11::tuple getWallOverridePoints()")
