...
public:
	...
	enum FracVals		// Exposed to Python
	{
		FRAC_WRAP_X					= (0x0001),
		FRAC_WRAP_Y					= (0x0002),
	...
	DllExport void fracInit(int iNewXs, int iNewYs, int iGrain, CvRandom& random, int iFlags, CvFractal* pRifts=nullptr, int iFracXExp=DEFAULT_FRAC_X_EXP, int iFracYExp=DEFAULT_FRAC_Y_EXP);	// Exposed to Python
	DllExport void fracInitHinted(int iNewXs, int iNewYs, int iGrain, CvRandom& random, const uint8_t* pbyHints, int iHintsLength, int iFlags, CvFractal* pRifts, int iFracXExp=DEFAULT_FRAC_X_EXP, int iFracYExp=DEFAULT_FRAC_Y_EXP); // Exposed to Python
...
protected:
	...
	void fracInitInternal(int iNewXs, int iNewYs, int iGrain, CvRandom& random, const uint8_t* pbyHints, int iHintsLength, int iFlags, CvFractal* pRifts, int iFracXExp, int iFracYExp);
