...
public:
	...
	bool generatePath(const CvPlot* pToPlot, PathingArg args = 0, bool bReuse = false, int* piPathTurns = nullptr) const;	// Exposed to Python
	...
	DllExportForInterface int baseMoves() const;																			// Exposed to Python
	int maxMoves() const;																									// Exposed to Python
	DllExportForInterface int movesLeft() const;																			// Exposed to Python			
	...
	DllExportForInterface bool isHurt() const;																				// Exposed to Python						
	DllExport bool isDead() const;																				// Exposed to Python						

	void setBaseCombatStr(int iCombat);																																										// Exposed to Python
	DllExportForInterface int baseCombatStr() const;																																										// Exposed to Python
	int maxCombatStr(const CvPlot* pPlot, const CvUnit* pAttacker, CombatDetails* pCombatDetails = nullptr) const;		// Exposed to Python
	int currCombatStr(const CvPlot* pPlot, const CvUnit* pAttacker, CombatDetails* pCombatDetails = nullptr) const;	// Exposed to Python
	...
	bool canDefend(const CvPlot* pPlot = nullptr) const;																	// Exposed to Python
	bool canSiege(TeamTypes eTeam) const;																							// Exposed to Python

	DllExportForInterface int airBaseCombatStr() const;																						// Exposed to Python
	...
	DllExport bool canAirDefend(const CvPlot* pPlot = nullptr) const;										// Exposed to Python
	...
	DllExportForInterface bool isFortifyable() const;																							// Exposed to Python
	...
	DllExport UnitTypes getUnitType() const;																					// Exposed to Python
	...
	bool isEnemy(TeamTypes eTeam, const CvPlot* pPlot = nullptr) const;
...
protected:
	...
	void collateralCombat(const CvPlot* pPlot, CvUnit* pSkipUnit = nullptr);
	void flankingStrikeCombat(const CvPlot* pPlot, int iAttackerStrength, int iAttackerFirepower, int iDefenderOdds, int iDefenderDamage, CvUnit* pSkipUnit = nullptr);
