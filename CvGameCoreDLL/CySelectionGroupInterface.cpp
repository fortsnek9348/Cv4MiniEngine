...
void CySelectionGroupInterface(pybind11::module m)
{
	...
	pybind11::class_<CySelectionGroup>(m, "CySelectionGroup")
		...
		.def("lastMissionPlot", &CySelectionGroup::lastMissionPlot, pybind11::return_value_policy::take_ownership, "CvPlot* ()")
		...
		.def("plot", &CySelectionGroup::plot, pybind11::return_value_policy::take_ownership, "CyPlot () - get plot that the group is on")
		.def("area", &CySelectionGroup::area, pybind11::return_value_policy::take_ownership, "CyArea ()*")
		...
		.def("getPathFirstPlot", &CySelectionGroup::getPathFirstPlot, pybind11::return_value_policy::take_ownership, "CyPlot* ()")
		.def("getPathEndTurnPlot", &CySelectionGroup::getPathEndTurnPlot, pybind11::return_value_policy::take_ownership, "CyPlot* ()")
		...
		.def("getMissionFromQueue", &CySelectionGroup::getMissionFromQueue, pybind11::return_value_policy::take_ownership, "MissionData* (int iIndex)")
		.def("getHeadUnit", &CySelectionGroup::getHeadUnit, pybind11::return_value_policy::take_ownership, "CyUnit* ()")
		.def("getUnitAt", &CySelectionGroup::getUnitAt, pybind11::return_value_policy::take_ownership, "CyUnit* (int index)")
