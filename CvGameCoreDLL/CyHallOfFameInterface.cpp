...
void CyHallOfFameInterface(pybind11::module m)
{
	...
	pybind11::class_<CyReplayInfo>(m, "CyReplayInfo")
		.def(pybind11::init())
	...
	pybind11::class_<CyHallOfFameInfo>(m, "CyHallOfFameInfo")
		.def(pybind11::init())
		.def("loadReplays", &CyHallOfFameInfo::loadReplays, "void ()")
		.def("getNumGames", &CyHallOfFameInfo::getNumGames, "int ()")
		.def("getReplayInfo", &CyHallOfFameInfo::getReplayInfo, pybind11::return_value_policy::take_ownership, "CyReplayInfo* (int i)")
		;
}
