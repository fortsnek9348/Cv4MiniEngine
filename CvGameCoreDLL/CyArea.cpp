...
//#else
	// Actual value not available. For now, python only checks if positive, like the rest of the code.
	//return m_pArea ? (m_pArea->getBestFoundValueIsPositive((PlayerTypes)eIndex) ? 1 : 0) : -1;
//#endif
}
