...
{
	SelectionCamera_DIRTY_BIT,		// 0x0000'0001
	Fog_DIRTY_BIT,					// 0x0000'0002
	GlobeLayer_DIRTY_BIT,			// 0x0000'0004
	GlobeInfo_DIRTY_BIT,			// 0x0000'0008
	Waypoints_DIRTY_BIT,			// 0x0000'0010
	PercentButtons_DIRTY_BIT,		// 0x0000'0020
	MiscButtons_DIRTY_BIT,			// 0x0000'0040
	PlotListButtons_DIRTY_BIT,		// 0x0000'0080
	SelectionButtons_DIRTY_BIT,		// 0x0000'0100
	CitizenButtons_DIRTY_BIT,		// 0x0000'0200
	ResearchButtons_DIRTY_BIT,		// 0x0000'0400
	Event_DIRTY_BIT,				// 0x0000'0800
	Center_DIRTY_BIT,				// 0x0000'1000
	GameData_DIRTY_BIT,				// 0x0000'2000
	Score_DIRTY_BIT,				// 0x0000'4000
	TurnTimer_DIRTY_BIT,			// 0x0000'8000
	Help_DIRTY_BIT,					// 0x0001'0000
	MinimapSection_DIRTY_BIT,		// 0x0002'0000
	SelectionSound_DIRTY_BIT,		// 0x0004'0000
	Cursor_DIRTY_BIT,				// 0x0008'0000
	CityInfo_DIRTY_BIT,				// 0x0010'0000
	UnitInfo_DIRTY_BIT,				// 0x0020'0000
	Popup_DIRTY_BIT,				// 0x0040'0000
	CityScreen_DIRTY_BIT,			// 0x0080'0000
	InfoPane_DIRTY_BIT,				// 0x0100'0000
	Flag_DIRTY_BIT,					// 0x0200'0000
	HighlightPlot_DIRTY_BIT,		// 0x0400'0000
	ColoredPlots_DIRTY_BIT,			// 0x0800'0000
	BlockadedPlots_DIRTY_BIT,		// 0x1000'0000
	Financial_Screen_DIRTY_BIT,		// 0x2000'0000
	Foreign_Screen_DIRTY_BIT,		// 0x4000'0000
	Soundtrack_DIRTY_BIT,			// 0x8000'0000
	Domestic_Advisor_DIRTY_BIT,		// 0x0000'0000
	Espionage_Advisor_DIRTY_BIT,	// 0x0000'0000
	Advanced_Start_DIRTY_BIT,		// 0x0000'0000
...
enum WidgetTypes					// Exposed to Python
{
	...
	// fortsnek: Need this to know when to call CvGameInterface::getWidgetHelp. Probably.
//#ifdef _USRDLL
	NUM_WIDGET_TYPES
//#endif
};
