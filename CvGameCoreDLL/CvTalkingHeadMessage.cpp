...
CvTalkingHeadMessage::CvTalkingHeadMessage(int iMessageTurn, int iLen, const wchar_t* pszDesc, const TCHAR* pszSound, InterfaceMessageTypes eType, const TCHAR* pszIcon, ColorTypes eColor, int iX, int iY, bool bShowOffScreenArrows, bool bShowOnScreenArrows) :
...
void CvTalkingHeadMessage::setSound(const TCHAR* pszSound)
{
	m_szSound = pszSound;
}
...
void CvTalkingHeadMessage::setIcon(const TCHAR* pszIcon)
{
	m_szIcon = pszIcon;
}
