...
public:
	...
	const char* getEntityEventTypes(int i) const { return GC.getEntityEventTypes((EntityEventTypes) i).c_str(); }
	const char* getAnimationOperatorTypes(int i) const { return GC.getAnimationOperatorTypes((AnimationOperatorTypes) i).c_str(); }
	const char* getFunctionTypes(int i) const { return GC.getFunctionTypes((FunctionTypes) i).c_str(); }
	const char* getFlavorTypes(int i) const { return GC.getFlavorTypes((FlavorTypes) i).c_str(); }
	const char* getArtStyleTypes(int i) const { return GC.getArtStyleTypes((ArtStyleTypes) i).c_str(); }
	const char* getCitySizeTypes(int i) const { return GC.getCitySizeTypes(i).c_str(); }
	const char* getContactTypes(int i) const { return GC.getContactTypes((ContactTypes) i).c_str(); }
	const char* getDiplomacyPowerTypes(int i) const { return GC.getDiplomacyPowerTypes((DiplomacyPowerTypes) i).c_str(); }
	const char *getFootstepAudioTypes(int i) { return GC.getFootstepAudioTypes(i).c_str(); }
	const char *getFootstepAudioTags(int i) { return GC.getFootstepAudioTags(i).c_str(); }
