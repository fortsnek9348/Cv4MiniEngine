...
public:
	...
	int getCivicAnarchyLength(pybind11::list& /*CivicTypes**/ paeNewCivics);
	...
	int getCivicUpkeep(pybind11::list&  /*CivicTypes*/ paiCivics, bool bIgnoreAnarchy);
	...
	pybind11::tuple firstCity(bool bRev);	// returns tuple of (CyCity, iterOut)
	pybind11::tuple nextCity(int iterIn, bool bRev);		// returns tuple of (CyCity, iterOut)
	int getNumCities();
	CyCity* getCity(int iID);
	pybind11::tuple firstUnit(bool bRev);	// returns tuple of (CyUnit, iterOut)
	pybind11::tuple nextUnit(int iterIn, bool bRev);		// returns tuple of (CyUnit, iterOut)
	int getNumUnits();
	CyUnit* getUnit(int iID);
	pybind11::tuple firstSelectionGroup(bool bRev);	// returns tuple of (CySelectionGroup, iterOut)
	pybind11::tuple nextSelectionGroup(int iterIn, bool bRev);	// returns tuple of (CySelectionGroup, iterOut)
