...
{
public:
	// fortsnek: Exporting for engine messages. Firaxis have a slightly different message data class it seems.
	DllExport CvMessageData(GameMessageTypes eType);
	DllExport virtual ~CvMessageData();
