...
void CyGamePythonInterface(pybind11::module m)
{
	...
	pybind11::class_<CyGame>(m, "CyGame")
		.def(pybind11::init())
		...
		.def("getHolyCity", &CyGame::getHolyCity, pybind11::return_value_policy::take_ownership, "CyCity getHolyCity()")
		...
		.def("getHeadquarters", &CyGame::getHeadquarters, pybind11::return_value_policy::take_ownership, "CyCity getHeadquarters()")
		...
		.def("getDeal", &CyGame::getDeal, pybind11::return_value_policy::take_ownership)
		.def("addDeal", &CyGame::addDeal, pybind11::return_value_policy::take_ownership)
		.def("getMapRand", &CyGame::getMapRand, pybind11::return_value_policy::reference)
		.def("getMapRandNum", &CyGame::getMapRandNum)
		.def("getSorenRand", &CyGame::getSorenRand, pybind11::return_value_policy::reference)
		...
		.def("getReplayInfo", &CyGame::getReplayInfo, pybind11::return_value_policy::take_ownership)
	...
	pybind11::class_<CyDeal>(m, "CyDeal")
		...
		.def("getFirstTrade", &CyDeal::getFirstTrade, pybind11::return_value_policy::reference)
		.def("getSecondTrade", &CyDeal::getSecondTrade, pybind11::return_value_policy::reference)
