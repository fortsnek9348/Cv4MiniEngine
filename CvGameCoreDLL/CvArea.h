...
//#else
//	void setBestFoundValueIsPositive(PlayerTypes eIndex, bool isPositive);
//#endif
	// Equivelent to getBestFoundValue > 0 without ENABLE_GAMECOREDLL_ENHANCEMENTS.
	//bool getBestFoundValueIsPositive(PlayerTypes eIndex) const;
