...
void CyPlayerPythonInterface1(pybind11::class_<CyPlayer>& x)
{
	...
	x
		...
		.def("findStartingPlot", &CyPlayer::findStartingPlot, pybind11::return_value_policy::take_ownership, "findStartingPlot(bool bRandomize) - Finds a starting plot for player")

		.def("initCity", &CyPlayer::initCity, pybind11::return_value_policy::take_ownership, "initCity( plotX, plotY ) - spawns a city at x,y")
		...
		.def("initUnit", &CyPlayer::initUnit, pybind11::return_value_policy::take_ownership, "CyUnit* initUnit(UnitTypes iIndex, plotX, plotY, UnitAITypes iIndex)  - place Unit at X,Y   NOTE: Always use UnitAITypes.NO_UNITAI")
		...
		.def("getStartingPlot", &CyPlayer::getStartingPlot, pybind11::return_value_policy::take_ownership, "CyPlot* ()")
		...
		.def("getCapitalCity", &CyPlayer::getCapitalCity, pybind11::return_value_policy::take_ownership, "CyCity* (int iID)")
		...
		.def("getCity", &CyPlayer::getCity, pybind11::return_value_policy::take_ownership, "CyCity* (int iID)")
		...
		.def("getUnit", &CyPlayer::getUnit, pybind11::return_value_policy::take_ownership, "CyUnit* (int iID)")
		...
		.def("getSelectionGroup", &CyPlayer::getSelectionGroup, pybind11::return_value_policy::take_ownership, "CvSelectionGroup* (int iID)")

		.def("trigger", &CyPlayer::trigger, "void (/*EventTriggerTypes*/int eEventTrigger)")
		.def("getEventOccured", &CyPlayer::getEventOccured, pybind11::return_value_policy::reference, "EventTriggeredData* (int /*EventTypes*/ eEvent)")
		.def("resetEventOccured", &CyPlayer::resetEventOccured, "void (int /*EventTypes*/ eEvent)")
		.def("getEventTriggered", &CyPlayer::getEventTriggered, pybind11::return_value_policy::reference, "EventTriggeredData* (int iID)")
		.def("initTriggeredData", &CyPlayer::initTriggeredData, pybind11::return_value_policy::reference, "EventTriggeredData* (int eEventTrigger, bool bFire, int iCityId, int iPlotX, int iPlotY, PlayerTypes eOtherPlayer, int iOtherPlayerCityId, ReligionTypes eReligion, CorporationTypes eCorporation, int iUnitId, BuildingTypes eBuilding)")
