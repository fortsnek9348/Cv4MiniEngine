...
public:
	...
	virtual uint8_t GetLandscapePlotTerrainData(unsigned int uiX, unsigned int uiY, unsigned int uiPointX, unsigned int uiPointY) = 0;
	virtual uint8_t GetLandscapePlotHeightData(unsigned int uiX, unsigned int uiY, unsigned int uiPointX, unsigned int uiPointY) = 0;
	...
	virtual unsigned int GetGameCellSizeX() = 0;
	virtual unsigned int GetGameCellSizeY() = 0;
	...
	virtual void LightenVisibility(unsigned int) = 0;
	virtual void DarkenVisibility(unsigned int) = 0;
	virtual void BlackenVisibility(unsigned int) = 0;
