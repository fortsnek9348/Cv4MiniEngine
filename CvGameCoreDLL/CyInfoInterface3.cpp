...
void CyInfoPythonInterface3(pybind11::module m)
{
	...
	pybind11::class_<CvYieldInfo, CvInfoBase >(m, "CvYieldInfo")
	...
	pybind11::class_<CvTerrainInfo, CvInfoBase >(m, "CvTerrainInfo")
	...
	pybind11::class_<CvInterfaceModeInfo, CvInfoBase >(m, "CvInterfaceModeInfo")
	...
	pybind11::class_<CvLeaderHeadInfo, CvInfoBase >(m, "CvLeaderHeadInfo")
	...
	// CvProcessInfos
	pybind11::class_<CvProcessInfo, CvInfoBase >(m, "CvProcessInfo")
	...
	pybind11::class_<CvVoteInfo, CvInfoBase >(m, "CvVoteInfo")
	...
	pybind11::class_<CvProjectInfo, CvInfoBase >(m, "CvProjectInfo")
	...
	pybind11::class_<CvReligionInfo, CvInfoBase >(m, "CvReligionInfo")
	...
	pybind11::class_<CvCorporationInfo, CvInfoBase >(m, "CvCorporationInfo")
	...
	pybind11::class_<CvTraitInfo, CvInfoBase >(m, "CvTraitInfo")
	...
	// CvWorldInfo
	pybind11::class_<CvWorldInfo, CvInfoBase >(m, "CvWorldInfo")
	...
	pybind11::class_<CvClimateInfo, CvInfoBase >(m, "CvClimateInfo")
	...
	pybind11::class_<CvSeaLevelInfo, CvInfoBase >(m, "CvSeaLevelInfo")
		.def("getSeaLevelChange", &CvSeaLevelInfo::getSeaLevelChange, "int ()")
		;

	pybind11::class_<CvAssetInfoBase>(m, "CvAssetInfoBase")
	...
	pybind11::class_<CvArtInfoAsset, CvAssetInfoBase >(m, "CvArtInfoAsset")
	...
	pybind11::class_<CvArtInfoScalableAsset, CvArtInfoAsset, CvScalableInfo>(m, "CvArtInfoScalableAsset")
		;

	pybind11::class_<CvArtInfoInterface, CvArtInfoAsset >(m, "CvArtInfoInterface")
		;

	pybind11::class_<CvArtInfoMovie, CvArtInfoAsset >(m, "CvArtInfoMovie")
		;

	pybind11::class_<CvArtInfoMisc, CvArtInfoAsset >(m, "CvArtInfoMisc")
		;

	pybind11::class_<CvArtInfoUnit, CvArtInfoScalableAsset >(m, "CvArtInfoUnit")
		.def("getInterfaceScale", &CvArtInfoUnit::getInterfaceScale, "float ()")
		.def("getKFM", &CvArtInfoUnit::getKFM, "string ()")
		;

	pybind11::class_<CvArtInfoBuilding, CvArtInfoScalableAsset >(m, "CvArtInfoBuilding")
		.def("isAnimated", &CvArtInfoBuilding::isAnimated, "bool ()")
		;

	pybind11::class_<CvArtInfoCivilization, CvArtInfoAsset >(m, "CvArtInfoCivilization")
		.def("isWhiteFlag", &CvArtInfoCivilization::isWhiteFlag, "bool ()")
		;

	pybind11::class_<CvArtInfoLeaderhead, CvArtInfoAsset >(m, "CvArtInfoLeaderhead")
		;

	pybind11::class_<CvArtInfoBonus, CvArtInfoScalableAsset >(m, "CvArtInfoBonus")
		;

	pybind11::class_<CvArtInfoImprovement, CvArtInfoScalableAsset >(m, "CvArtInfoImprovement")
		.def("isExtraAnimations", &CvArtInfoImprovement::isExtraAnimations, "bool ()")
		;

	pybind11::class_<CvArtInfoTerrain, CvArtInfoAsset >(m, "CvArtInfoTerrain")
		;

	pybind11::class_<CvArtInfoFeature, CvArtInfoScalableAsset >(m, "CvArtInfoFeature")
	...
	pybind11::class_<CvEmphasizeInfo, CvInfoBase >(m, "CvEmphasizeInfo")
	...
	pybind11::class_<CvUpkeepInfo, CvInfoBase >(m, "CvUpkeepInfo")
		.def("getPopulationPercent", &CvUpkeepInfo::getPopulationPercent, "int ()")
		.def("getCityPercent", &CvUpkeepInfo::getCityPercent, "int ()")
		;

	pybind11::class_<CvCultureLevelInfo, CvInfoBase >(m, "CvCultureLevelInfo")
	...
	pybind11::class_<CvEraInfo, CvInfoBase >(m, "CvEraInfo")
	...
	pybind11::class_<CvColorInfo, CvInfoBase >(m, "CvColorInfo")
		.def("getColor", &CvColorInfo::getColor,  pybind11::return_value_policy::reference)
		;

	pybind11::class_<CvPlayerColorInfo, CvInfoBase >(m, "CvPlayerColorInfo")
	...
	pybind11::class_<CvGameText, CvInfoBase >(m, "CvGameText")
		.def(pybind11::init()) // fortsnek: This is used in CvOptionsScreen.py.
	...
	pybind11::class_<CvDiplomacyTextInfo, CvInfoBase >(m, "CvDiplomacyTextInfo")
		.def("getResponse", &CvDiplomacyTextInfo::getResponse,  pybind11::return_value_policy::reference, "Response (int iNum)")
	...
	pybind11::class_<CvDiplomacyInfo, CvInfoBase >(m, "CvDiplomacyInfo")
		.def("getResponse", &CvDiplomacyInfo::getResponse,  pybind11::return_value_policy::reference, "CvDiplomacyResponse (int iNum)")
	...
	pybind11::class_<CvEffectInfo, CvInfoBase, CvScalableInfo>(m, "CvEffectInfo")
		.def("getPath", &CvEffectInfo::getPath, "string ()")
		.def("setPath", &CvEffectInfo::setPath, "void (string)")
		;

	pybind11::class_<CvControlInfo, CvInfoBase >(m, "CvControlInfo")
		.def("getActionInfoIndex", &CvControlInfo::getActionInfoIndex, "int ()")
		;

	pybind11::class_<CvQuestInfo, CvInfoBase >(m, "CvQuestInfo")
	...
	pybind11::class_<CvTutorialMessage>(m, "CvTutorialMessage")
	...
	pybind11::class_<CvTutorialInfo, CvInfoBase >(m, "CvTutorialInfo")
		...
		.def("getTutorialMessage", &CvTutorialInfo::getTutorialMessage,  pybind11::return_value_policy::reference, "CvTutorialMessage* (int iIndex)")
		;

	pybind11::class_<CvAutomateInfo, CvInfoBase >(m, "CvAutomateInfo")
		;

	pybind11::class_<CvCommandInfo, CvInfoBase >(m, "CvCommandInfo")
		;

	pybind11::class_<CvGameOptionInfo, CvInfoBase >(m, "CvGameOptionInfo")
		.def("getDefault", &CvGameOptionInfo::getDefault, "bool ()")
		.def("getVisible", &CvGameOptionInfo::getVisible, "bool ()")
		;

	pybind11::class_<CvMPOptionInfo, CvInfoBase >(m, "CvMPOptionInfo")
		.def("getDefault", &CvMPOptionInfo::getDefault, "bool ()")
		;

	pybind11::class_<CvForceControlInfo, CvInfoBase >(m, "CvForceControlInfo")
		.def("getDefault", &CvForceControlInfo::getDefault, "bool ()")
		;

	pybind11::class_<CvPlayerOptionInfo, CvInfoBase >(m, "CvPlayerOptionInfo")
		.def("getDefault", &CvPlayerOptionInfo::getDefault, "bool ()")
		;

	pybind11::class_<CvGraphicOptionInfo, CvInfoBase >(m, "CvGraphicOptionInfo")
		.def("getDefault", &CvGraphicOptionInfo::getDefault, "bool ()")
		;

	pybind11::class_<CvEventTriggerInfo, CvInfoBase >(m, "CvEventTriggerInfo")
	...
	pybind11::class_<CvEventInfo, CvInfoBase >(m, "CvEventInfo")
	...
	pybind11::class_<CvEspionageMissionInfo, CvInfoBase >(m, "CvEspionageMissionInfo")
	...
	pybind11::class_<CvVoteSourceInfo, CvInfoBase >(m, "CvVoteSourceInfo")
	...
	pybind11::class_<CvMainMenuInfo, CvInfoBase >(m, "CvMainMenuInfo")
