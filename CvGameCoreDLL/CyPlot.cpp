...
//#else
	//return m_pPlot ? m_pPlot->grabLazyFoundValue((PlayerTypes)eIndex) : -1;
//#endif
}
...
{
	return m_pPlot ? m_pPlot->isInvisibleVisible((TeamTypes) eTeam, (InvisibleTypes) eInvisible) : (bool)-1;
}
...
{
	return m_pPlot ? m_pPlot->getScriptData().c_str() : "";
}
