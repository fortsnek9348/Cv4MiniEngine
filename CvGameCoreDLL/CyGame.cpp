...
{
	return (nullptr != m_pGame ? m_pGame->getMaxTurns() : -1);
}
...
{
	return (nullptr != m_pGame ? m_pGame->getMaxCityElimination() : -1);
}
...
{
	return (nullptr != m_pGame ? m_pGame->getNumAdvancedStartPoints() : -1);
}
...
{
	return (nullptr != m_pGame ? m_pGame->getStartTurn() : -1);
}

int CyGame::getStartYear() const
{
	return (nullptr != m_pGame ? m_pGame->getStartYear() : -1);
}
...
{
	return (nullptr != m_pGame ? m_pGame->getEstimateEndTurn() : -1);
}
...
{
	return (nullptr != m_pGame ? m_pGame->getTurnSlice() : -1);
}

int CyGame::getMinutesPlayed() const
{
	return (nullptr != m_pGame ? m_pGame->getMinutesPlayed() : 0);
}

int CyGame::getTargetScore() const
{
	return (nullptr != m_pGame ? m_pGame->getTargetScore() : -1);
}
...
{
	return (nullptr != m_pGame ? m_pGame->getMaxPopulation() : 0);
}

int CyGame::getMaxLand() const
{
	return (nullptr != m_pGame ? m_pGame->getMaxLand() : 0);
}

int CyGame::getMaxTech() const
{
	return (nullptr != m_pGame ? m_pGame->getMaxTech() : 0);
}

int CyGame::getMaxWonders() const
{
	return (nullptr != m_pGame ? m_pGame->getMaxWonders() : 0);
}

int CyGame::getInitPopulation() const
{
	return (nullptr != m_pGame ? m_pGame->getInitPopulation() : 0);
}

int CyGame::getInitLand() const
{
	return (nullptr != m_pGame ? m_pGame->getInitLand() : 0);
}

int CyGame::getInitTech() const
{
	return (nullptr != m_pGame ? m_pGame->getInitTech() : 0);
}

int CyGame::getInitWonders() const
{
	return (nullptr != m_pGame ? m_pGame->getInitWonders() : 0);
}

int CyGame::getAIAutoPlay() const
{
	return (nullptr != m_pGame ? m_pGame->getAIAutoPlay() : 0);
}
...
{
	return m_pGame ? new CyCity(m_pGame->getHolyCity((ReligionTypes) eIndex)) : nullptr;
}
...
{
	if (m_pGame)
		m_pGame->setHolyCity((ReligionTypes) eIndex, nullptr, false);
}

CyCity* CyGame::getHeadquarters(int /*CorporationTypes*/ eIndex)
{
	return m_pGame ? new CyCity(m_pGame->getHeadquarters((CorporationTypes) eIndex)) : nullptr;
}
...
{
	if (m_pGame)
		m_pGame->setHeadquarters((CorporationTypes) eIndex, nullptr, false);
}
...
pybind11::bytes CyGame::getScriptData() const
{
	return m_pGame ? m_pGame->getScriptData() : std::string();
}
...
{
	return (nullptr != m_pGame ? m_pGame->getReplayMessageTurn(i) : -1);
}

ReplayMessageTypes CyGame::getReplayMessageType(int i) const
{
	return (nullptr != m_pGame ? m_pGame->getReplayMessageType(i) : NO_REPLAY_MESSAGE);
}

int CyGame::getReplayMessagePlotX(int i) const
{
	return (nullptr != m_pGame ? m_pGame->getReplayMessagePlotX(i) : -1);
}

int CyGame::getReplayMessagePlotY(int i) const
{
	return (nullptr != m_pGame ? m_pGame->getReplayMessagePlotY(i) : -1);
}

int CyGame::getReplayMessagePlayer(int i) const
{
	return (nullptr != m_pGame ? m_pGame->getReplayMessagePlayer(i) : -1);
}

ColorTypes CyGame::getReplayMessageColor(int i) const
{
	return (nullptr != m_pGame ? m_pGame->getReplayMessageColor(i) : NO_COLOR);
}

std::wstring CyGame::getReplayMessageText(int i) const
{
	return (nullptr != m_pGame ? m_pGame->getReplayMessageText(i) : L"");
}

unsigned int CyGame::getNumReplayMessages() const
{
	return (nullptr != m_pGame ? m_pGame->getNumReplayMessages() : 0);
}

CyReplayInfo* CyGame::getReplayInfo() const
{
	return (nullptr != m_pGame ? (new CyReplayInfo(m_pGame->getReplayInfo())) : nullptr);
}

bool CyGame::hasSkippedSaveChecksum() const
{
	return (nullptr != m_pGame ? m_pGame->hasSkippedSaveChecksum() : false);
}
...
{
	return (nullptr != m_pGame ? m_pGame->isCivEverActive((CivilizationTypes)eCivilization) : false);
}

bool CyGame::isLeaderEverActive(int /*LeaderHeadTypes*/ eLeader)
{
	return (nullptr != m_pGame ? m_pGame->isLeaderEverActive((LeaderHeadTypes)eLeader) : false);
}

bool CyGame::isUnitEverActive(int /*UnitTypes*/ eUnit)
{
	return (nullptr != m_pGame ? m_pGame->isUnitEverActive((UnitTypes)eUnit) : false);
}

bool CyGame::isBuildingEverActive(int /*BuildingTypes*/ eBuilding)
{
	return (nullptr != m_pGame ? m_pGame->isBuildingEverActive((BuildingTypes)eBuilding) : false);
}

bool CyGame::isEventActive(int /*EventTriggerTypes*/ eTrigger)
{
	return (nullptr != m_pGame ? m_pGame->isEventActive((EventTriggerTypes)eTrigger) : false);
}
