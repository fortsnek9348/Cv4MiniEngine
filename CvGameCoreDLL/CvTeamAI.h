...
public:
	...
	static CvTeamAI& getTeam(TeamTypes eTeam)
	{
		...
		FAssertMsg(std::to_underlying(eTeam) < MAX_TEAMS, "eTeam is not assigned a valid value");
	...
	virtual void AI_reset(bool bConstructor) override;
	virtual void AI_doTurnPre() override;
	virtual void AI_doTurnPost() override;
	virtual void AI_makeAssignWorkDirty() override;
	virtual void AI_updateAreaStragies(bool bTargets = true) override;
	virtual bool AI_shareWar(TeamTypes eTeam) const override;			// Exposed to Python
	virtual void AI_updateWorstEnemy() override;
	virtual int AI_getAtWarCounter(TeamTypes eIndex) const override;     // Exposed to Python
	virtual void AI_setAtWarCounter(TeamTypes eIndex, int iNewValue) override;
	virtual int AI_getAtPeaceCounter(TeamTypes eIndex) const override;
	virtual void AI_setAtPeaceCounter(TeamTypes eIndex, int iNewValue) override;
	virtual int AI_getHasMetCounter(TeamTypes eIndex) const override;
	virtual void AI_setHasMetCounter(TeamTypes eIndex, int iNewValue) override;
	virtual int AI_getOpenBordersCounter(TeamTypes eIndex) const override;
	virtual void AI_setOpenBordersCounter(TeamTypes eIndex, int iNewValue) override;
	virtual int AI_getDefensivePactCounter(TeamTypes eIndex) const override;
	virtual void AI_setDefensivePactCounter(TeamTypes eIndex, int iNewValue) override;
	virtual int AI_getShareWarCounter(TeamTypes eIndex) const override;
	virtual void AI_setShareWarCounter(TeamTypes eIndex, int iNewValue) override;
	virtual int AI_getWarSuccess(TeamTypes eIndex) const override;    // Exposed to Python
	virtual void AI_setWarSuccess(TeamTypes eIndex, int iNewValue) override;
	virtual void AI_changeWarSuccess(TeamTypes eIndex, int iChange) override;
	virtual int AI_getEnemyPeacetimeTradeValue(TeamTypes eIndex) const override;
	virtual void AI_setEnemyPeacetimeTradeValue(TeamTypes eIndex, int iNewValue) override;
	virtual int AI_getEnemyPeacetimeGrantValue(TeamTypes eIndex) const override;
	virtual void AI_setEnemyPeacetimeGrantValue(TeamTypes eIndex, int iNewValue) override;
	virtual WarPlanTypes AI_getWarPlan(TeamTypes eIndex) const override;
	virtual bool AI_isChosenWar(TeamTypes eIndex) const override;
	virtual bool AI_isSneakAttackPreparing(TeamTypes eIndex) const override;
	virtual bool AI_isSneakAttackReady(TeamTypes eIndex) const override;
	virtual void AI_setWarPlan(TeamTypes eIndex, WarPlanTypes eNewValue, bool bWar = true) override;
