...
int CyReplayInfo::getReplayMessageTurn(int i) const
{
	if (m_pHoF)
	{
		return m_pHoF->getReplayMessageTurn((unsigned int)i);
	}
	return -1;
}
...
int CyReplayInfo::getReplayMessageType(int i) const
{
	if (m_pHoF)
	{
		return (int)m_pHoF->getReplayMessageType((unsigned int)i);
	}
	return -1;
}
...
int CyReplayInfo::getReplayMessagePlotX(int i) const
{
	if (m_pHoF)
	{
		return m_pHoF->getReplayMessagePlotX((unsigned int)i);
	}
	return -1;
}
...
int CyReplayInfo::getReplayMessagePlotY(int i) const
{
	if (m_pHoF)
	{
		return m_pHoF->getReplayMessagePlotY((unsigned int)i);
	}
	return -1;
}
...
int CyReplayInfo::getReplayMessagePlayer(int i) const
{
	if (m_pHoF)
	{
		return (int)m_pHoF->getReplayMessagePlayer((unsigned int)i);
	}
	return -1;
}
...
const std::wstring CyReplayInfo::getReplayMessageText(int i) const
{
	...
	if (m_pHoF)
	{
		szText = m_pHoF->getReplayMessageText((unsigned int)i);
	}
	return szText;
}
...
int CyReplayInfo::getReplayMessageColor(int i) const
{
	if (m_pHoF)
	{
		return (int)m_pHoF->getReplayMessageColor((unsigned int)i);
	}
	return -1;
}
