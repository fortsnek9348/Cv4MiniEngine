...
void CyUnitPythonInterface1(pybind11::class_<CyUnit>& x)
{
	...
	x
		...
		.def("getPathEndTurnPlot", &CyUnit::getPathEndTurnPlot, pybind11::return_value_policy::take_ownership, "CyPlot* ()")
		...
		.def("bombardTarget", &CyUnit::bombardTarget, pybind11::return_value_policy::take_ownership, "CyCity* (CyPlot* pPlot)")
		...
		.def("bestInterceptor", &CyUnit::bestInterceptor, pybind11::return_value_policy::take_ownership, "CyUnit* (CyPlot*)")
		...
		.def("getGroup", &CyUnit::getGroup, pybind11::return_value_policy::take_ownership, "CySelectionGroup* ()")
		...
		.def("plot", &CyUnit::plot, pybind11::return_value_policy::take_ownership, "CyPlot* ()")
		.def("area", &CyUnit::area, pybind11::return_value_policy::take_ownership, "CyArea* ()")
		.def("getReconPlot", &CyUnit::getReconPlot, pybind11::return_value_policy::take_ownership, "CyPlot* ()")
		...
		.def("getTransportUnit", &CyUnit::getTransportUnit, pybind11::return_value_policy::take_ownership, "CyUnit* ()")
		...
		.def("getArtInfo", &CyUnit::getArtInfo,  pybind11::return_value_policy::reference, "CvArtInfoUnit* (int i, eEra)")
