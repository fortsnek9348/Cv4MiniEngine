...
void CyPlotPythonInterface1(pybind11::class_<CyPlot>& x)
{
	...
	x
		...
		.def("getNearestLandPlot", &CyPlot::getNearestLandPlot, pybind11::return_value_policy::take_ownership, "CyPlot* ()")
		...
		.def("getBestDefender", &CyPlot::getBestDefender, pybind11::return_value_policy::take_ownership, "CyUnit* (int (PlayerTypes) eOwner, int (PlayerTypes) eAttackingPlayer, CvUnit* pAttacker, bool bTestAtWar, bool bTestPotentialEnemy, bool bTestCanMove)")
		.def("getSelectedUnit", &CyPlot::getSelectedUnit, pybind11::return_value_policy::take_ownership, "CyUnit* ()")
		...
		.def("area", &CyPlot::area, pybind11::return_value_policy::take_ownership, "CyArea* ()")
		.def("waterArea", &CyPlot::waterArea, pybind11::return_value_policy::take_ownership, "CyArea* ()")
		...
		.def("getPlotCity", &CyPlot::getPlotCity, pybind11::return_value_policy::take_ownership, "CyCity* ()")
		.def("getWorkingCity", &CyPlot::getWorkingCity, pybind11::return_value_policy::take_ownership, "CyCity* ()")
		.def("getWorkingCityOverride", &CyPlot::getWorkingCityOverride, pybind11::return_value_policy::take_ownership, "CyCity* ()")
		...
		.def("getUnit", &CyPlot::getUnit, pybind11::return_value_policy::take_ownership, "CyUnit* (int iIndex)")
