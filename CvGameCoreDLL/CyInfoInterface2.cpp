...
void CyInfoPythonInterface2(pybind11::module m)
{
	...
	pybind11::class_<CvBuildingClassInfo, CvInfoBase >(m, "CvBuildingClassInfo")
	...
	pybind11::class_<CvRouteModelInfo, CvInfoBase >(m, "CvRouteModelInfo")
	...
	pybind11::class_<CvCivilizationInfo, CvInfoBase >(m, "CvCivilizationInfo")
	...
	pybind11::class_<CvVictoryInfo, CvInfoBase >(m, "CvVictoryInfo")
	...
	pybind11::class_<CvHurryInfo, CvInfoBase >(m, "CvHurryInfo")
	...
	pybind11::class_<CvHandicapInfo, CvInfoBase >(m, "CvHandicapInfo")
	...
	pybind11::class_<CvGameSpeedInfo, CvInfoBase >(m, "CvGameSpeedInfo")
		...
		.def("getGameTurnInfo", &CvGameSpeedInfo::getGameTurnInfo, pybind11::return_value_policy::reference, "GameTurnInfo ()")
		;

	pybind11::class_<CvTurnTimerInfo, CvInfoBase >(m, "CvTurnTimerInfo")
	...
	pybind11::class_<CvBuildInfo, CvInfoBase >(m, "CvBuildInfo")
	...
	pybind11::class_<CvGoodyInfo, CvInfoBase >(m, "CvGoodyInfo")
	...
	pybind11::class_<CvRouteInfo, CvInfoBase >(m, "CvRouteInfo")
	...
	pybind11::class_<CvImprovementBonusInfo, CvInfoBase >(m, "CvImprovementBonusInfo")
	...
	pybind11::class_<CvImprovementInfo, CvInfoBase >(m, "CvImprovementInfo")
	...
	pybind11::class_<CvBonusClassInfo, CvInfoBase >(m, "CvBonusClassInfo")
		.def("getUniqueRange", &CvBonusClassInfo::getUniqueRange)
		;

	pybind11::class_<CvBonusInfo, CvInfoBase >(m, "CvBonusInfo")
		...
		.def("getArtInfo", &CvBonusInfo::getArtInfo,  pybind11::return_value_policy::reference, "CvArtInfoBonus ()")
		;

	pybind11::class_<CvFeatureInfo, CvInfoBase >(m, "CvFeatureInfo")
	...
	pybind11::class_<CvCommerceInfo, CvInfoBase >(m, "CvCommerceInfo")
