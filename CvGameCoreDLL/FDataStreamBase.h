...
public:
	...
	// fortsnek: Changing return types to void. Unused.
	
	virtual void	WriteString(const wchar_t *szName) = 0;
	virtual void	WriteString(const char *szName) = 0;
	virtual void	WriteString(const std::string& szName) = 0;
	virtual void	WriteString(const std::wstring& szName) = 0;
	virtual void	WriteString(int count, std::string values[]) = 0;
	virtual void	WriteString(int count, std::wstring values[]) = 0;

	virtual void	ReadString(char *szName) = 0;
	virtual void	ReadString(wchar_t *szName) = 0;
	virtual void	ReadString(std::string& szName) = 0;
	virtual void	ReadString(std::wstring& szName) = 0;
	virtual void	ReadString(int count, std::string values[]) = 0;
	virtual void	ReadString(int count, std::wstring values[]) = 0;
	...
	// fortsnek: Commenting out for for Linux
