...
public:
	...
	virtual void playGeneralSound(const TCHAR* pszSound, NiPoint3 vPos = NiPoint3(-1.0f, -1.0f, -1.0f)) = 0;
	...
	virtual void addMessage(PlayerTypes ePlayer, bool bForce, int iLength, CvWString szString, const TCHAR* pszSound = nullptr,
		InterfaceMessageTypes eType = MESSAGE_TYPE_INFO, const char* pszIcon = nullptr, ColorTypes eFlashColor = NO_COLOR,
	...
	virtual void popupSetHeaderString( CvPopup* pPopup, CvWString szText, unsigned int uiFlags = DLL_FONT_CENTER_JUSTIFY ) = 0;
	virtual void popupSetBodyString( CvPopup* pPopup, CvWString szText, unsigned int uiFlags = DLL_FONT_LEFT_JUSTIFY, char *szName = nullptr, CvWString szHelpText = "" ) = 0;
	...
	virtual void popupSetPopupType( CvPopup* pPopup, PopupEventTypes ePopupType, const TCHAR* szArtFileName = nullptr ) = 0;
	...
	virtual void popupAddGenericButton( CvPopup* pPopup, CvWString szText, const char* szIcon = 0, int iButtonId = -1, WidgetTypes eWidgetType = WIDGET_GENERAL, int iData1 = INT_MAX, int iData2 = INT_MAX,
