...
public:
	...
	DllExport int getReplayMessageTurn(unsigned int i) const;
	DllExport ReplayMessageTypes getReplayMessageType(unsigned int i) const;
	DllExport int getReplayMessagePlotX(unsigned int i) const;
	DllExport int getReplayMessagePlotY(unsigned int i) const;
	DllExport PlayerTypes getReplayMessagePlayer(unsigned int i) const;
	DllExport const wchar_t* getReplayMessageText(unsigned int i) const;
	DllExport unsigned int getNumReplayMessages() const;
	DllExport ColorTypes getReplayMessageColor(unsigned int i) const;

	DllExport int getInitialTurn() const;
	DllExport int getFinalTurn() const;
	DllExport int getStartYear() const;
	DllExport const wchar_t* getFinalDate() const;
