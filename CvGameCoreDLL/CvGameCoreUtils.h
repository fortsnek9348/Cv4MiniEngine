...
template<class T> HECK_FORCEINLINE T getSign( T x ) { return (( x < 0 ) ? T(-1) : x > 0 ? T(1) : T(0)); };
...
DllExportForInterface bool isLimitedWonderClass(BuildingClassTypes eBuildingClass);					// Exposed to Python
