...
namespace cvengine
{
	...
	{
	public:
		explicit RichTextTable(CvWidgetDataStruct widgetData, cvengine::PythonScreenControlId pythonScreenControlId);
	...
	private:
		...
		cvengine::PythonScreenControlId mPythonScreenControlId{};
